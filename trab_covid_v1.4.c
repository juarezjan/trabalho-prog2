...
int main()
{
    ...
    t_data item4_ini, item4_fin;
    scanf("%d-%d-%d %d-%d-%d", &item4_ini.ano, &item4_ini.mes, &item4_ini.dia, &item4_fin.ano, &item4_fin.mes, &item4_fin.dia);

    int item5_numero;
    t_data item5_ini, item5_fin;
    scanf("%d %d-%d-%d %d-%d-%d", &item5_numero, &item5_ini.ano, &item5_ini.mes, &item5_ini.dia, &item5_fin.ano, &item5_fin.mes, &item5_fin.dia);
    top_n(p_casos, item5_numero, item5_ini, item5_fin, saida);
